...
s.name         = "LXBluetoothLibrary"          #导入pod后的名称
s.version      = "0.1.4"                     #当前版本号
...
s.source       = { :git => "https://github.com/arrfu/JFBluetoothLib.git", :tag => "0.1.4" }        #项目地址, 不支持ssh
s.source_files  = "bluetooth/**/*"   #源代码文件地址,表示platform-ios-libraries/bluetooth及其子文件夹下的所有.h和.m文件
